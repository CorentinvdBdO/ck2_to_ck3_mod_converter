...
| `gfx/portraits/portrait_modifiers` | shadow_dirty | 32 | 10 | 15 | 522 | 8/25/28 (replace_path: EK2) | 507 character: references to vanilla developer easter-egg characters, in 8 of 33 files; 2105 history.cpp "non-existent character" errors. EK2 replace_paths the folder and stubs 15 files. shadow_dirty keeps the 25 clothing/rank files that are pure mechanics. |
| `gfx/court_scene/scene_cultures` | shadow_dirty | 1 | 1 | 18 | 18 | 2/1/1 | 18 title_links in 1 of 2 files; the other is the culture-to-scene mechanic. |
| `gfx/interface/illustrations/scripted_illustrations` | shadow_dirty | 7 | 1 | 40 | 206 | 1/1/3 | 40 title_links in 1 of 8 files. |
