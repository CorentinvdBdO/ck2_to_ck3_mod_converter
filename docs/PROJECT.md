...
|---|---|---|---|
| converter (this repo) | `paradox/ck3/ck2_to_ck3_mod_converter` | CK2 mod → CK3 mod, algorithmic, re-runnable | — |
| converted mod (generated) | `paradox/ck3/claudespace/mods/faerun_ck3` | raw converter output, **never hand-edited**, regenerated on every Faerun update | `fae_` (generated) |
| Forgotten Kings submod | `paradox/ck3/claudespace/mods/forgotten_kings` | human gameplay/flavour work on top of the converted mod | `fk_` |
...
1. `foundation` — parser round-trip with comments, CLI, tests, CK3 target 1.19 dims, output into `claudespace/mods/faerun_ck3`.
