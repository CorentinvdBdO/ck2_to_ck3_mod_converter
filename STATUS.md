...
| faerun_ck2_to_ck3_converted (generated) | `paradox/ck3/claudespace/mods/faerun_ck2_to_ck3_converted` | main 483d1d8 | github.com/CorentinvdBdO/faerun_ck2_to_ck3_converted (private) | build 3 2026-09-08 22:30; tiger fatal 0; headless -test pending (user's game was running) |
...
## Last results
- 2026-09-08 — build 3: 15 steps, 1368 files; ck3-tiger fatal 0 / error 58 (41 loc hash collisions, 14 wrong-gender, 2 unknown-field, 1 history; `docs/evidence/tiger_build3_2026-09-08.txt`); pytest 1058; headless -test pending.
...
## Next 3
1. Headless `-test` of build 3 once the user's CK3 exits (Monitor armed), then user playtest 3 (`docs/playtest.md`): clothes, traits, terrain paint, relief.
